    ...
    <div className="fixed w-full h-screen top-0 left-0 bg-black/20 z-10">
      <div className="col-center h-full">
        <div ref={ref} className="bg-white p-8 w-[400px] rounded-3xl">
          <h3 className="text-lg leading-6 font-semibold text-gray-900 mb-4">Silinsin mi?</h3>
          <p className="text-gray-500">Bu işlem geri alınamaz. Veri her yerden kaldırılacak.</p>
